...
outcome:
  ...
  detail:
  # When new resource was create via update
  - text: New resource created
    coding:
    - code: MSG_CREATED
      system: http://terminology.hl7.org/CodeSystem/operation-outcome
      display: New resource created
  # When new resource was updated via update
...
entity:
- what:
    reference: "ResourceType/resource/_history/prev-version"
    role:
      code: "4"
...
- what:
    reference: "ResourceType/resource/_history/next-version"
    role:
      code: "4"
      system: http://terminology.hl7.org/CodeSystem/object-role
      display: Domain Resource
